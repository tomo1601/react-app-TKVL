              ...
              <div className="col-md-3 col-sm-12 tab-sidebar">
                <div className="mobile-box mg-right-10">
                  <div className="box-summary link-list">
                    ...
                    <div
                      className="row summary-item gradient-border"
                    ...
                    >
                      ...
                      >
                        <span className="content-label"> CV Submitted</span>
                        {listCVLoading && (
                          <span className="content-label spinner-border spinner-border-sm mr-1"></span>
                        )}
                      </div>
                      <CVSubmitModal />
                    </div>
