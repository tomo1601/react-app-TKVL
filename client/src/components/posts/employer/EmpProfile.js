...
const EmpProfile = () => {
  ...
  const {authState:{user:{city,avatar,email,name,  phone, address, employee, fieldName  }}} =useContext(AuthContext)
    ...
    <div className='ContactInfoView_viewSectionWrapper__SEvGW'>
      <Form className='native-grid'>
        <Row className='row'>
          ...
          <Col className='col-12 col-lg-6'>
            <div className='undefined row'>
              <span className='undefined col-4' >Field:</span>
              <div className='col-8 text-truncate fw-6' >{fieldName}</div>
            </div>
          </Col>
          <Col className='col-12 col-lg-6'>
            <div className='undefined row'>
              <span className='undefined col-4'>Employee:</span>
              <div className='col-8 text-truncate fw-6'>{employee}</div>
            </div>
          </Col>
          <Col className='col-12 col-lg-6'>
            <div className='undefined row'>
