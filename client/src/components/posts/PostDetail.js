...
const PostDetail = () => {
  ...
  const { postState: { posts }, findPostById } = useContext(PostContext)
  const { authState: { user }, submitUserCV } = useContext(AuthContext)
  ...
  const onChangeSelectMedia = event => setCvSubmit({
    ...cvSubmit, mediaId: event.value
  })
            ...
            <div className='col-lg-3 col-md-3 col-btn col-btn-save-section '>
              <div className='row'>
                <div className='col-xs-6 col-xs-push-6 col-md-12 col-md-push-0'>
                  ...
                  <Button className='btn btn-primary btn-block btn-apply track-event' variant='warning' onClick={onApplyCV}> Apply now</Button>
                ...
                <div className='box-summary link-list'>
                  ...
                  <div className='row summary-item'>
                    ...
                    <div className='col-xs-10 summary-content'>
                      ...
                      <span className='content'> {posts.salary} {posts.salaryType}</span>
                    </div>
                  </div>
                  <div className='row summary-item'>
                    <div className='col-xs-2 summary-icon'>
